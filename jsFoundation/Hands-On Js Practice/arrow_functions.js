...
const squareNumbers = arr => arr.map(element => element * element);

const filterEvenNumbers = arr => arr.filter(element => element % 2 == 0);

const sumPositiveNumbers = arr => arr.filter(element => element > 0).reduce((a, b) => a + b, 0);
